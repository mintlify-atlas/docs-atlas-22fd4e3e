---
title: "GET /api/stream — serve local files with range support"
sidebarTitle: "Stream"
description: "Serve local video files from the server filesystem with HTTP range support. Powers nano's local media library on Node.js. Not supported on Cloudflare."
---
