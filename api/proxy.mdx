...
description: "nano's server-side proxy fetches remote stream URLs, rewrites M3U8 playlist segment paths through the proxy, and strips restrictive CORS/CSP headers for browser playback."
---
