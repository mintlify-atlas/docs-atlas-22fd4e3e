...
sidebarTitle: "Search"
description: "Search TMDB for movies and TV shows by query string. Returns popularity-sorted, paginated results. Falls back to a built-in static list on TMDB failure."
---
