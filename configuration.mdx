---
title: "Configure nano with environment variables"
sidebarTitle: "Configuration"
description: "All nano settings are controlled via environment variables. Covers server, TMDB, database, theming, features, and video player options with defaults and valid values."
---
...
| `DEFAULT_SERVER` | `nemu` | Default scraper server ID loaded when opening the player. The production default in `config.shiopa.ts` is `rei`; `.env.example` ships with `nemu`. Set this to your preferred server ID. |
