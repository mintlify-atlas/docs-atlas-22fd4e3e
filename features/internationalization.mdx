---
title: "nano supports 17 UI languages out of the box"
sidebarTitle: "Internationalization"
description: "nano ships full UI translations for 17 languages. Set a default locale with DEFAULT_LOCALE and let users switch languages via the header language selector."
---
