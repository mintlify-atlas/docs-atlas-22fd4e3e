---
title: "Deploy nano with Docker: Image, Compose, and Env Vars"
sidebarTitle: "Docker"
description: "Run nano as a Docker container using the pre-built GHCR image or build from source. Covers Docker Compose setup and all environment variables."
---
